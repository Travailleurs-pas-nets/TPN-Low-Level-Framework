...
static MunitResult test_handleCriticalError(const MunitParameter params[], void *data) {
    ...
    handleCriticalError("999999999", "4444", LL_PROD);
    handleCriticalError("999999999", "4444", LL_DEBUG);
