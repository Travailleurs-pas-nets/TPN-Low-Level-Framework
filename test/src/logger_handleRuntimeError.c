...
static MunitResult test_handleRuntimeError(const MunitParameter params[], void *data) {
    ...
    handleRuntimeError("999999999", "4444", LL_PROD);
    handleRuntimeError("999999999", "4444", LL_DEBUG);
